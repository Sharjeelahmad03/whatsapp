          ...
          children: [
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      CircleAvatar(
                        backgroundImage: AssetImage('fashionmen.jpg'),
                      ),
                      SizedBox(width: 15),
                      Expanded(
                        child: Container(
            ...
            SizedBox(
              ...
              child: ListView(
                ...
                children: [
                  StoryCard(
                    containerImage: 'Summer-vibes.jpg',
                    avatarImage: 'food-app.jpg',
                    name: 'My Story',
                  ),
                  StoryCard(
                    containerImage: 'Haniya.jpg',
                    avatarImage: 'Haniyabackground.jpg',
                    name: 'Haniya Amir',
                  ),
                  StoryCard(
                    containerImage: 'fashionmen.jpg',
                    avatarImage: 'Haniya.jpg',
                    name: 'Imran Khan',
                  ),
                  StoryCard(
                    containerImage: 'food-app.jpg',
                    avatarImage: 'fashionmen.jpg',
                    name: 'Pakistani Foods',
                  ),
                ],
              ),
            ),
            ...
            PostCard(
              ...
              userImage: 'fashionmen.jpg',
              postText: 'Summer vibes!',
              postImage: 'summer-vibes.jpg',
              likes: '48850',
              comments: '485',
            ),
            PostCard(
              userName: 'Lassani Food',
              userImage: 'food-app.jpg',
              postText: 'Lassani Pizza Point!',
              postImage: 'food-app.jpg',
              likes: '294556',
              comments: '8959',
            ),
          ],
